...
```html
<div data-pym-src="https://static.startribune.com/news/projects/all/20191116-polling">Loading...</div>
...
```js
{
  "publish": {
    "default": {
      ...
      "path": "news/projects-staging/all/20191116-polling/",
      "url": "http://static.startribune.com/news/projects-staging/all/20191116-polling/"
    },
    "production": {
      "bucket": "static.startribune.com",
      "path": "news/projects/all/20191116-polling/",
      "url": "http://static.startribune.com/news/projects/all/20191116-polling/"
    }
  }
}
```
